                ...
                <Layout className="site-layout">
                    <Content style={{ margin: '24px 16px 0', overflow: 'initial' }}>
                        <div className="site-layout-background" style={{ padding: 24 }}>
                            <div className="site-engineer-inventory-manage">
                                <div className="site-engineer-inventory-manage-header">
                                    <h1 className="site-engineer-inventory-manage-title">
                                        ALL INVENTORY ITEMS
                                    </h1>
                                    <Button
                                        type="primary"
                                        className="site-engineer-inventory-manage-add-button"
                                ...
                                <div className="site-engineer-inventory-manage-data">
                                    <Input
                                        placeholder="Search Item Name..."
                                        className="site-engineer-inventory-manage-search-input"
                                        value={searchInput}
...
export default SiteEngineerInventory;

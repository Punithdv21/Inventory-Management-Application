      ...
      <Layout className='site-layout'>
        ...
        <Content className='content'>
          <div className='content-header'>
            <Title level={2} style={{ color: '#1890ff', marginBottom: 0 }}>ALL LABORS</Title>
          ...
          >
            ...
            >
              ...
              <Form.Item
                name='laborPayment'
                label='Labor Payment'
                rules={[{ required: true, message: 'Please enter labor payment' }]}
              >
                <InputNumber min={0} style={{ width: '100%' }} />
              </Form.Item>
            </Form>
